...
{
    public class TercihEdilenKonutConfiguration : IEntityTypeConfiguration<TercihEdilenKonut>
    {
        public void Configure(EntityTypeBuilder<TercihEdilenKonut> builder)
        {
            builder.Property(k => k.BasvuruId)
                  .HasMaxLength(500)
                  .IsRequired();

            builder.Property(k => k.KonutId)
                  .HasMaxLength(500)
                  .IsRequired();
            ...
            builder.ToTable("TercihEdilenKonuts");
        }
    }
}
