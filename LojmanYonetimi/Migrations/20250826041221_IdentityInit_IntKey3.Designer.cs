...
namespace LojmanYonetimi.Migrations
{
    ...
    [Migration("20250826041221_IdentityInit_IntKey3")]
    partial class IdentityInit_IntKey3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LojmanYonetimi.Entities.Basvuru", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BasvuruDurum")
                        .IsRequired()
                        .HasMaxLength(30)
                    ...
                    b.Property<int>("TahsisId")
                        .HasColumnType("int");

                    b.Property<string>("TasisTuru")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");

                    b.Property<string>("TercihEdilenKampus")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("TercihEdilenKonut")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("Basvurus", (string)null);
                });
            ...
            modelBuilder.Entity("LojmanYonetimi.Entities.KonutCikisBasvuru", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CikisBasvuruDurumEnum")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
                    ...
                    b.ToTable("KonutCikisBasvurus", (string)null);
                });
            ...
            modelBuilder.Entity("LojmanYonetimi.Entities.Tahsis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LojmanYonetimi.Entities.KonutCikisBasvuru", b =>
                {
                    b.HasOne("LojmanYonetimi.Entities.Basvuru", "Basvuru")
                        .WithMany()
                        .HasForeignKey("BasvuruId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LojmanYonetimi.Entities.Tahsis", "Tahsis")
                        .WithMany()
                        .HasForeignKey("TahsisId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
